...
// Ensure complete removal of WebBrowser module execution if user doesn't physically have the linking intent configured natively
// WebBrowser.maybeCompleteAuthSession(); 
                ...
                >
                    ...
                    <View style={styles.header}>
                        <Text style={[styles.headerGreeting, { color: isDark ? theme.colors.accent : theme.colors.secondary }]}>
                            {mode === 'login' ? "WELCOME BACK" : (mode === 'signup' ? "START JOURNEY" : "RECOVERY")}
                        </Text>
                        <Text style={[styles.title, { color: isDark ? theme.dark.textMain : theme.light.textMain }]}>
                            {mode === 'login' ? "Step Into Your Space" : (mode === 'signup' ? "Begin Today" : "Find Your Way")}
                        </Text>
                    </View>
                    ...
                    <Card isDark={isDark} style={styles.authCard} intensity={isDark ? 30 : 70} noPadding>
                        <View style={styles.cardInner}>
                            {mode !== 'reset' && (
                                <View style={[styles.tabs, { backgroundColor: isDark ? 'rgba(255,255,255,0.06)' : 'rgba(124,58,237,0.08)' }]}>
                                    <TouchableOpacity
                                        style={[styles.tab, mode === 'login' && [styles.activeTab, { backgroundColor: isDark ? theme.dark.cardSolid : 'rgba(255,255,255,0.92)' }]]}
                                        onPress={() => { setMode('login'); setError(""); }}
                                    >
                                        <Feather name="log-in" size={18} color={mode === 'login' ? theme.colors.secondary : theme.light.textSub} style={{ marginRight: 8 }} strokeWidth={1.35} />
                                    ...
                                    >
                                        <Feather name="user-plus" size={18} color={mode === 'signup' ? theme.colors.secondary : theme.light.textSub} style={{ marginRight: 8 }} strokeWidth={1.35} />
                                ...
                                <View style={styles.formContainer}>
                                    ...
                                    >
                                        <View style={styles.googleIconContainer}>
                                            <Image
                                                source={{ uri: 'https://companieslogo.com/img/orig/GOOG-1af06ea7.png?t=1632517861' }}
...
const styles = StyleSheet.create({
    ...
    googleIconContainer: {
        ...
        justifyContent: 'center',
        backgroundColor: '#fff',
        marginRight: 12, // replaced gap with margin
    },
    googleIcon: {
        width: 18,
        height: 18,
